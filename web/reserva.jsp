...
<section id="content"><div class="ic"></div>
  <div class="container">
	...
	<div class="greet">
  <h3 class="head__1">
              <marquee>CADASTRO DE RESERVAS</marquee>
          </h3>
		  </div>
...
<ul class="form-style-1">
    ...
    <li>
        ...
        <option value="Advertise">Lucas Feliciano</option>
        <option value="Partnership">Jaire Rodrigues</option>
        <option value="General Question">Thiago</option>
        </select>
    </li>
        <label>Data <span class="required">*</span></label>
        <input type="email" name="Data" class="field-long" />
    </li>
