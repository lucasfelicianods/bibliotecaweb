                            ...
                            <div class="block-3">
                                ...
                                <form>
                                    <ul class="form-style-1">
                                        ...
                                        <li>
                                            <a href="artigo.jsp"> <input onClick="window.open('artigo.jsp')"  type="submit" size="200" value="Cadastrar Artigo  " /></a>
                                        </li>
                                        <li>
                                            <a href="artigo.jsp"><input type="submit" value="Cadastrar Livro    " /></a>
                                        </li>
                                        <li>
                                             <a href="artigo.jsp"><input type="submit" value="Cadastrar Revista " /></a>
                                        </li>
                                        <li>
                                            <a href="artigo.jsp"> <input type="submit" value="Cadastrar Video    " /></a>
                                        <li>
                                    </ul>
                                </form>
